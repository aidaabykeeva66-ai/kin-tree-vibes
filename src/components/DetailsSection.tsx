      ...
      <div className="container grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            KinTree создан для реальных семейных историй. Мы даём инструменты, чтобы зафиксировать то, что вы знаете сегодня, и оставляем место для открытий завтрашнего дня.
          </p>
